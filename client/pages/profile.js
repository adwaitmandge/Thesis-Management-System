import { CleaningServices, Image } from "@mui/icons-material";
...
const ProfilePage = () => {
  ...
  return (
    <main class="profile-page mt-[250px]">
      <section class="relative block h-500-px">
        <div class="absolute top-0 w-full h-full bg-center bg-cover bg-[url('https://images.unsplash.com/photo-1499336315816-097655dcfbda?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=2710&amp;q=80')] ">
          <span
            id="blackOverlay"
