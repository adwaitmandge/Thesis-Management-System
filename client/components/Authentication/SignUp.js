...
const SignUp = () => {
  ...
  const postDetails = (pics) => {
    ...
    if (pics.type === "image/jpeg" || pics.type === "image/png") {
      ...
      data.append("upload_preset", "ThesisManagementSystem");
      data.append("cloud_name", "dnkhiub4n");
      fetch("https://api.cloudinary.com/v1_1/dnkhiub4n/image/upload", {
        method: "POST",
        body: data,
      })
        .then((res) => res.json())
  ...
  return (
    <VStack spacing="5px">
      ...
      <FormControl id="registrationId" isRequired>
      ...
      <FormControl id="pic">
        <FormLabel className="flex">Upload your Picture</FormLabel>
        <Input
          type="file"
          p={1.5}
          accept="image/*"
