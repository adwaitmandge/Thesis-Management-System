...
const SingleChat = ({ fetchAgain, setFetchAgain }) => {
  ...
  return (
    <>
      {selectedChat ? (
        <>
          <Text className="text-[28px] md:text-[30px] pb-2 px-2 w-[100%] font-sans flex justify-between items-center">
            <IconButton
              className="md:none flex"
              //   d={{ base: "flex", md: "none" }}
              icon={<ArrowBackIcon />}
          ...
          <Box className="flex flex-col p-3 justify-end bg-[#e8e8e8] w-[100%] h-[100%] rounded-lg overflow-y-hidden">
            {loading ? (
              <Spinner
                size="xl"
                w={20}
